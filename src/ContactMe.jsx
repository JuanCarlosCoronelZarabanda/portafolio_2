        ...
        <div>
            ...
            <div className="flex items-center sm:px-20 sm:gap-5 md:px-72 md:py-60 md:gap-40  ">
                ...
                <div className=" hover:bg-[#212258] text-center">
                    <h1 className=" text-[#08dcf8]"><IconBrandLinkedin stroke-width="3" width="50" height="50" />Juan Carlos Coronel Zarabanda </h1>
                </div></a>
                <a href="https://github.com/JuanCarlosCoronelZarabanda?tab=repositories">
                <div className=" hover:bg-[#212258] text-center">
                    <h1 className=" text-[#08dcf8]"> <IconBrandGithub stroke-width="3" width="50" height="50" /> Juan Carlos Coronel Zarabanda </h1>
                </div></a>
                <a href="jcoronelzarabanda@gmail.com">
                <div className=" hover:bg-[#212258] text-center">
                    <h1 className=" text-[#08dcf8]"> <IconMail stroke-width="3" width="50" height="50" />jcoronelzarabanda
                    @gmail.com</h1>
                </div></a>
                <a href="https://web.whatsapp.com/">
                <div className=" hover:bg-[#212258] text-center">
                    <h1 className=" text-[#08dcf8]"><IconBrandWhatsapp stroke-width="3" width="50" height="50" />3224328940 / 3005478524 </h1>
                </div></a>
            </div>
